...
if __name__ == "__main__":
    ...
    for a in range(epoch):
        ...
        f = open('DRL_model_convergence_experiment/DRL_results_real_data_new_50%.txt', 'a+')
        ...
        if a % 25 == 0:
            ...
            with open("DRL_model_experiment/DRL_model_50%_data.json", "w") as json_file:
                json_file.write(model_json)
            # serialize weights to HDF5
            exp_replay.model.save_weights("DRL_model_experiment/DRL_model_50%_data.h5")
