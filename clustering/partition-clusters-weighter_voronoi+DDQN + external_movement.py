...
if __name__ == "__main__":
    ...
    model_input_size = total_node_number**2 + total_node_number + total_node_number + total_location_dim     # [neighbor connectivity matrix] + [cluster ID of nodes].
    ...
    f = open('dqn_results_test_without_behavior.txt', 'w')
    f.close()
    ...
    for a in range(epoch):
        ...
        f = open('dqn_results_test_without_behavior.txt', 'a+')
