...
if __name__ == "__main__":
    ...
    model_input_size = total_node_number**2 + total_node_number + total_node_number + total_location_dim + total_behavior_dim #+ 2 + 1    # [neighbor connectivity matrix] + [cluster ID of nodes].
    ...
    for a in range(epoch):
        ...
        f = open('dqn_results_test_with_behavior.txt', 'a+')
