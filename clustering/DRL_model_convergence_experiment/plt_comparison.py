...
average_reward = []
f = open("DRL_results_25%_real_data_benchmark_40_nodes.txt", "r")    #dqn_results_full_synthetic_data   #dqn_results_full_synthetic_data_but_without_combined_probability #dqn_results_static #dqn_results_full_real_world_data
counter = 0
for x in f:
...
counter = 0
average_reward1 = []
f1 = open("DRL_results_25%_real_data_40_nodes.txt", "r")
for x in f1:
...
counter = 0
average_reward2 = []
f2 = open("DRL_model_25%_synthetic_data_40_nodes_new.txt", "r")
for x in f2:
...
plt.legend(("Dynamic Clustering", "Dynamic Clustering with Target Behavior Prediction","Dynamic Clustering with Synthetic Data and Target Behavior Prediction"), loc="higher right")
