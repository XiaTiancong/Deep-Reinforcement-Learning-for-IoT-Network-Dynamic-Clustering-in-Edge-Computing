...
average_reward = []
f = open("dqn_results_25%_synthetic_data_2_clusters.txt", "r")    #dqn_results_full_synthetic_data   #dqn_results_full_synthetic_data_but_without_combined_probability #dqn_results_static #dqn_results_full_real_world_data
counter = 0
for x in f:
...
f.close()
average_reward1 = []
f1 = open("dqn_results_25%_real_world_data_benchmark_2_clusters.txt", "r")    #dqn_results_full_synthetic_data   #dqn_results_full_synthetic_data_but_without_combined_probability #dqn_results_static #dqn_results_full_real_world_data
counter = 0
for x in f1:
...
plt.plot(x1, p1(x1), 'r--', linewidth = 3)
