...
average_reward = []
f = open("dqn_results_with_naive_model_and_insufficient_data.txt", "r")    #dqn_results_with_naive_model_and_insufficient_data
counter = 0
for x in f:
...
plt.legend(("Dynamic Clustering with Weighted Voronoi and D3QN (Moving Average)", "Dynamic Clustering with Weighted Voronoi and D3QN (Polynomial Curve Fitting)"), loc="lower right")
