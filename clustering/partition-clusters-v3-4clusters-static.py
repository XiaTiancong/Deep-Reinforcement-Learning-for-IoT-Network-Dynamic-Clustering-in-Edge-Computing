...
if __name__ == "__main__":
    ...
    f = open('dqn_results_steps_converge2.txt', 'w')
    f.close()
    ...
    for a in range(epoch):
        ...
        for tick in range(0, game_time):			# In very epoch, we move the event for game_time. 
        ...
        f = open('dqn_results_steps_converge2.txt', 'a+')
