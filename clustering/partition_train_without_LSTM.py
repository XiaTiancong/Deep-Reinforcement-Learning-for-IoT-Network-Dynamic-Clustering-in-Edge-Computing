...
class Cluster(object,):
    ...
    def get_state(self, tick):
        ...
        state = state + [0]*total_behavior_dim                                      # here we add the position and behavior sesing
...
if __name__ == "__main__":
    ...
    for a in range(epoch):
        ...
        f = open('results/dqn_training_full_training_data_tackling_overfitting.txt', 'a+')
        ...
        if a % 25 == 0:
            ...
            with open("DRL models/DRL_model_full_training_data_tackling_overfitting.json", "w") as json_file:
                json_file.write(model_json)
            # serialize weights to HDF5
            exp_replay.model.save_weights("DRL models/DRL_model_full_training_data_tackling_overfitting.h5")
