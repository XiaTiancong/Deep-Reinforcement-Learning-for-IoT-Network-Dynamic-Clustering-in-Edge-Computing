...
if __name__ == "__main__":
    ...
    flag_benchmark_action = 1  # 0: DQN solution; 1: action is always 0, static solution, always stay at the same place.
    ...
    model_input_size = total_node_number ** 2 + total_node_number + total_node_number  # [neighbor connectivity matrix] + [cluster ID of nodes].
    ...
    DRL_model.load_weights("DRL_model_experiment/DRL_model_random_direction_benchmark.h5")
    ...
    for a in range(epoch):
        ...
        for tick in range(0, game_time):  # In every epoch, we move the event for game_time.
            ...
            if mem_state == []:
                ...
                network_state = env.network_state
                network_state = np.asarray(network_state)
        ...
        f = open('DRL_test/dqn_results_random_direction_static_solution_benchmark.txt', 'a+')
